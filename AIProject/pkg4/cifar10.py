...
def train():
    ...
    data_dir = '/userDocs/user000/workspaces/tmpWS00/vsNoVS00/proj/AIProject/pkg4/data/cifar-10-batches-bin/'
    log_dir = '/userDocs/user000/workspaces/tmpWS00/vsNoVS00/proj/AIProject/pkg4/logs234/'
...
def evaluate():
    with tf.Graph().as_default():
        ...
        log_dir = '/userDocs/user000/workspaces/tmpWS00/vsNoVS00/proj/AIProject/pkg4/logs10000/'
        test_dir = '/userDocs/user000/workspaces/tmpWS00/vsNoVS00/proj/AIProject/pkg4/data/cifar-10-batches-bin/'
        n_test = 10000
