...
def run_training():
    ...
    logs_train_dir = '/userDocs/user000/workspaces/tmpWS00/vsNoVS00/proj/DataForAiProject/catVsDog/trainedModels'
    logs_val_dir = '/userDocs/user000/workspaces/tmpWS00/vsNoVS00/proj/DataForAiProject/catVsDog/logs'
